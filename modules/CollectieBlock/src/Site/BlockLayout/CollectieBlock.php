<?php
namespace CollectieBlock\Site\BlockLayout;
 ...
 */
class CollectieBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Collectie'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/collectie-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/collectie-block', [
        'block' => $block,
