<?php
namespace FeedbackButton\Site\BlockLayout;
 ...
 */
class FeedbackButton extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Feedback Button'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/feedback-button-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/feedback-button', [
        'block' => $block,
