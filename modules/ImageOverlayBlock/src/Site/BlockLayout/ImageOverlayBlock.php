<?php
namespace ImageOverlayBlock\Site\BlockLayout;
 ...
 */
class ImageOverlayBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Image Overlay'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/image-overlay-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/image-overlay-block', [
        'block' => $block,
