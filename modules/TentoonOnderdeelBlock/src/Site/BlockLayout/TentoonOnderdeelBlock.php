<?php
namespace TentoonOnderdeelBlock\Site\BlockLayout;
 ...
 */
class TentoonOnderdeelBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Onderdeel Tentoonstelling'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/onderdeel-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/onderdeel-block', [
        'block' => $block,
