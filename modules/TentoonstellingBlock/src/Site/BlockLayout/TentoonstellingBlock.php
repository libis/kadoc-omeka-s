<?php
namespace TentoonstellingBlock\Site\BlockLayout;
 ...
 */
class TentoonstellingBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Tentoonstelling'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/tentoonstelling-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/tentoonstelling-block', [
        'block' => $block,
