<?php
namespace ToonIntroBlock\Site\BlockLayout;
 ...
 */
class ToonIntroBlock extends AbstractBlockLayout
{
    /**
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/toonIntro-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/toonIntro-block', [
        'block' => $block,
