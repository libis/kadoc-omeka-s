<?php
namespace VerhaalBlock\Site\BlockLayout;
 ...
 */
class VerhaalBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Verhaal'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/verhaal-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/verhaal-block', [
        'block' => $block,
