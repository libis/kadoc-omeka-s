<?php
namespace ZorgHeroBlock\Site\BlockLayout;
 ...
 */
class ZorgHeroBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Zorgerfgoed Hero'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/zorghero-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/zorghero-block', [
        'block' => $block,
